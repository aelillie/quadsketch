...
In order to compress a point set p and approximately maintain the relative distance between the points in p, a data structure referred to as a \texttt{sketch} is utilized. This section will cover how the sketch is build and analyze the parameters used in the algorithm and the impact of these on the running time and size of the sketch.
