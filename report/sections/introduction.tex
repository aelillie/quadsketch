...
\\
\\
The paper introduces several experiments demonstrating the efficiency of \qs{}. The authors have tested \qs{} along side with two other approximate nearest neighbor algorithms, \texttt{Product Quantization} referred to as \pq{} and scalar uniform quantization implementation referred to as \gr{}.\subsection{Motivation} %Why are we interested in this?
